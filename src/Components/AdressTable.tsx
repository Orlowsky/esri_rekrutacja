...
const AdressTable = (props: { adress: any; setNewLocationFunction: any; setNewValueIndexFunction:any}) => {
  return (
    <div style={adressTableMainDiv}>
      <div style={childDivAdressTable}>
        <p style={{ width: "38%", ...paragraphTitle }}>{process.env.REACT_APP_LABEL_ULICA}</p>
        <p style={{ width: "30%", ...paragraphTitle }}>{process.env.REACT_APP_LABEL_NUMER}</p>
            ...
            >
              ...
              <p
                onClick={() => {
                  ...
                  props.setNewValueIndexFunction('key'+index)
